...
export default function Chat(props: propsType) {
  ...
  return (
    <div className="flex flex-col gap-5 justify-end px-2 w-[100%] overflow-y-auto items-center">
      <div className=" overflow-y-scroll w-full" ref={chatDivRef}>
        {chats.map((chat, ind) => (
          <ChatText
            key={chat.id}
            text={chat.text}
